        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                <div class="card" style="min-height: 484px;">
                    <div class="card-body">
                        <form class="forms-sample" action="{{ route('admin_hotel_update',['id'=>$data->id]) }}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="details" placeholder="details" value="{{$data->details}}">
                                </div>
                            </div>
                            <div class="form-group row">
